...
{	
	...
	//PB1
	GPIO_Initure.Pin=GPIO_PIN_0; 				//PE0 时钟
	...
	//PB2
	GPIO_Initure.Pin=GPIO_PIN_3; 				//PB2 MISO
	GPIO_Initure.Mode=GPIO_MODE_INPUT;  		//上拉输入
	HAL_GPIO_Init(GPIOE,&GPIO_Initure);
	
	//PF9,11
	GPIO_Initure.Pin=GPIO_PIN_13; 	//PFD13 CS
	GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;  	//推挽输出
	HAL_GPIO_Init(GPIOD,&GPIO_Initure);
	GPIO_Initure.Pin=GPIO_PIN_2;	//PE2 MOSI
	HAL_GPIO_Init(GPIOE,&GPIO_Initure);
	//PF10
	GPIO_Initure.Pin=GPIO_PIN_4; 				//PE4中断引脚
